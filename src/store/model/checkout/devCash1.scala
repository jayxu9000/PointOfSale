...
class devCash1(machine: SelfCheckout, var itemsInMachine: Map[String, Item], var barcode: String, var receiptList: List[ReceiptLine], var taxList: List[Double]) extends State(machine){
  ...
  override def creditPressed(): Unit = {
    machine.state = new devCredit1(machine, itemsInMachine, barcode, receiptList, taxList)
  }
